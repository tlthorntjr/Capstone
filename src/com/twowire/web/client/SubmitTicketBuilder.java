...
public class SubmitTicketBuilder extends Widget {
	...
	private FlexTable constructFlexTable(SubmitTicketControlSet controls) {
		...
		flexTable.setHTML(2, 0, "<l1>*Severity</l1>");
		flexTable.setWidget(2, 1, controls.getSeverityListBox());
		flexTable.setHTML(3, 0, "<l1>Product:</l1>");
		flexTable.setHTML(3, 1, "<b1>associatedProductsFromDatabase</b1>");
		flexTable.setHTML(4, 0, "<l1>*Ticket Type</l1>");
		flexTable.setWidget(4, 1, controls.getTicketTypeListBox());
		flexTable.setHTML(5, 0, "<l1>Priority:</l1>");
		flexTable.setWidget(5, 1, controls.getPriorityListBox());
		flexTable.setHTML(6, 0, "<l1>Options</l1>");
		flexTable.setHTML(7, 0, "<l1>Attachment:</l1>");
		flexTable.setWidget(7, 1, controls.getAttachment());
		flexTable.setHTML(8, 0, "<l1>Email Notification:</l1>");
		flexTable.setWidget(8, 1, controls.getEmailNotify());
		flexTable.setWidget(9, 0, controls.getPreviewButton());
		flexTable.setWidget(9, 1, controls.getFinishButton());
